...
OOHStory-owned templates may be provisioned under ``resources/prompts``.
The electronic-library migration deliberately does not fall back to another
project's prompt tree.
"""
...
from oohstory_library.services.genre_catalog import canonical_genre_id, canonical_substyle_id, get_genre_bucket


APP_ROOT = Path(__file__).resolve().parents[3]
DEFAULT_PROMPTS_DIR = APP_ROOT / "resources" / "prompts"
...
PROMPT_SLOTS: List[Dict[str, Any]] = [
    {
        ...
        "name": "通用写作骨架",
        "group": "写作",
        "description": "追加在 oh-story 写作契约后的项目级输出骨架。",
    ...
    },
    {
        ...
        "name": "题材写作协议",
        "group": "写作",
        "description": "项目当前题材的本地补充协议，创建项目后固定为项目快照。",
    ...
    },
    {
        ...
        "name": "正文审查模板",
        "group": "审查",
        "description": "追加在 story-review 契约后的本地审查输出模板。",
        "filename": "review.md",
        ...
        prompts.append(
            {
                ...
                "source_label": f"oh-story 项目定制覆盖层 / {slot['filename']}",
