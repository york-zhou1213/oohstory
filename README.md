...
<p align="center">
  ...
  <a href="https://github.com/york-zhou1213/oohstory/releases/tag/web-v20260815-v15-28-oss1"><img alt="Release: web-v20260815-v15-28-oss1" src="https://img.shields.io/badge/release-web--v20260815--v15--28--oss1-7c3aed"></a>
...
<p align="center">
  ...
  <a href="https://github.com/york-zhou1213/oohstory/releases">版本发布</a> ·
...
当前公开版本：[`web-v20260815-v15-28-oss1`](https://github.com/york-zhou1213/oohstory/releases/tag/web-v20260815-v15-28-oss1)。
...
- **阅读体验**：章节目录、轻小说分卷与插图、智能多角色听书、后台连续播放、从正文坐标续听、收藏、书架和阅读记录。
- **社区互动**：段落评论、用户身份与阅读等级、评论点赞、通知和投稿中心。
- **书库管理**：书籍上下架、主封面与分卷封面、目录索引、同步任务、审计与恢复记录。
- **内容安全**：投稿格式检查、恶意文件检查、评论内容过滤、下载日额度、章节行为风控与签名蜜罐。
- **账户体系**：本地邮箱密码与可选 Google 登录并存，支持阅读进度、多端书架、通知与投稿记录同步。
...
近期公开代码同步记录见 [`CHANGELOG.md`](CHANGELOG.md)。生产封禁名单、真实域名、NAS 地址、OAuth/SMTP 参数、安装包和运行数据不会进入本仓库。
