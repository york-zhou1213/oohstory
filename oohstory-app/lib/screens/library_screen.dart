...
class _LibraryScreenState extends State<LibraryScreen> {
  ...
  String _statusLabel() => _statusOptions.firstWhere((o) => o.$1 == _serialization).$2;
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: _searchController.text.isNotEmpty
                  ? IconButton(
                      ...
                      onPressed: () { _searchController.clear(); _resetAndLoad(); },
                    )
                  : null,
            ),
      ...
      child: Row(
        children: [
          ...
          if (hasFilter) ...[
            ...
            GestureDetector(
              onTap: () {
                setState(() { _words = ''; _serialization = ''; });
                _resetAndLoad();
              },
              child: Container(
  ...
  Widget _filterChip(ThemeData theme, bool isDark, {
              ...
              children: options.map((opt) {
                ...
                return GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: selected ? AppTheme.seedPurple : (isDark ? const Color(0xFF2A2A40) : const Color(0xFFF5F5F8)),
                      borderRadius: BorderRadius.circular(12),
                      border: selected ? null : Border.all(color: theme.colorScheme.onSurface.withValues(alpha: 0.06)),
                    ),
                    child: Text(
                      opt.$2,
                      style: TextStyle(
