class Book {
  ...
  static int? _positiveChapterCount(dynamic value) {
  ...
  factory Book.fromJson(Map<String, dynamic> json) => Book(
    ...
    chapterCount:
        _positiveChapterCount(json['chapter_count']) ??
        _positiveChapterCount(json['approx_chapter_count']),
    status:
        json['serialization_status'] as String? ?? json['status'] as String?,
...
class Chapter {
  ...
  String get displayTitle =>
      label != null && label!.isNotEmpty ? '$label $title' : title;
...
class Deconstruction {
  ...
  factory Deconstruction.fromJson(Map<String, dynamic> json) => Deconstruction(
    ...
    documents:
        ...
        [],
    subdirectories:
        (json['subdirectories'] as List?)
            ?.map(
              (e) => DeconstructionSubdir.fromJson(e as Map<String, dynamic>),
            )
            .toList() ??
        [],
  );
...
class DeconstructionDoc {
  ...
  factory DeconstructionDoc.fromJson(Map<String, dynamic> json) =>
      DeconstructionDoc(
...
class DeconstructionSubdir {
  ...
  DeconstructionSubdir({
    required this.name,
    required this.label,
    required this.items,
  });

  factory DeconstructionSubdir.fromJson(Map<String, dynamic> json) =>
      DeconstructionSubdir(
        ...
        items:
            (json['items'] as List?)
                ?.map(
                  (e) =>
                      DeconstructionEntry.fromJson(e as Map<String, dynamic>),
                )
                .toList() ??
            [],
      );
...
class DeconstructionEntry {
  ...
  factory DeconstructionEntry.fromJson(Map<String, dynamic> json) =>
      DeconstructionEntry(
        filename: json['filename'] as String?,
        label: json['label'] as String? ?? '',
...
class Volume {
  ...
  factory Volume.fromJson(Map<String, dynamic> json) => Volume(
    ...
    title: json['title'] as String? ?? '',
    chapterIds:
        (json['chapter_ids'] as List?)?.map((e) => e as int).toList() ?? [],
    illustrationCount: json['illustration_count'] as int? ?? 0,
    coverPath: json['cover_path'] as String? ?? '',
    illustrationPaths:
        (json['illustration_paths'] as List?)
            ?.map((e) => e as String)
            .toList() ??
        [],
  );
